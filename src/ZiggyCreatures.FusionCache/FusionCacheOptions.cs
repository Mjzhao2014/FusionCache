	...
	: IOptions<FusionCacheOptions>
{
	...
	/// <summary>
	/// When using the simple circuit breaker for the distributed cache, specifies how many consecutive failures are allowed before opening the circuit.
	/// Defaults to 1.
	/// </summary>
	public int DistributedCacheCircuitBreakerFailuresAllowedBeforeBreaking { get; set; } = 1;
	/// <summary>
	/// If set to a value greater than 0, configures an advanced circuit breaker for the distributed cache: the failure threshold (0-1) that, when exceeded over the sampling window, will open the circuit.
	/// </summary>
	...
	/// <summary>
	/// The minimum number of calls that must occur for the advanced circuit breaker on the distributed cache to evaluate the failure rate.
	/// </summary>
	...
	/// <summary>
	/// The maximum amount of jitter to add to the circuit-breaker break duration for distributed cache.
	/// </summary>
	...
	/// <summary>
	/// The maximum amount of jitter to add to the backplane circuit-breaker break duration.
	/// </summary>
